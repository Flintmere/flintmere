...
- "Concierge audit" / "the audit" as the paid product's name (retired 2026-08-25, ADR 0028 — the product is **The Catalog Letter**; `/audit` → `/catalog-letter`). Per Amendment 1 (2026-08-25), "read" stays the **verb** ("we read your catalog") — the noun that collided with it is **Catalog Letter**, not "read." "Audit" survives only in the GDPR/SOC-2 legal register, as an SEO target term, and in code identifiers.
