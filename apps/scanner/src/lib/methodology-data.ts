...
export const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    why: 'AI shopping channels and merchant-side filters work on structured fields, not on free-text descriptions. A product with allergens buried in HTML cannot be filtered by a query like "show me dairy-free granola."',
    sources:
