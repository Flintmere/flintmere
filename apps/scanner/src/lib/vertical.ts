...
export const HOMEPAGE_VERTICAL_CONTENT: Record<HomepageVerticalId, HomepageVerticalContent> = {
  food: {
    ...
    bullets: [
      ...
      'Certifications taxonomy — Soil Association, Red Tractor, Fairtrade, Leaping Bunny.',
    ],
  ...
  beauty: {
    ...
    bullets: [
      'Standard in development. Free scanner runs all seven cross-vertical checks today.',
      'Food is our spearhead — see the canonical example before we publish for beauty.',
      'If you need a beauty cadence today, talk to the Flintmere team.',
    ],
  ...
  apparel: {
    ...
    bullets: [
      'Standard in development. Free scanner runs all seven cross-vertical checks today.',
      'Food is our spearhead — see the canonical example before we publish for apparel.',
      'If you need an apparel cadence today, talk to the Flintmere team.',
    ],
