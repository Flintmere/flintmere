...
const MISTAKES: Mistake[] = [
  ...
  },
  {
    ...
    symptom:
      "Your size chart is a designed image. Stunning for shoppers, unparseable as data. Returns rate stays high because agents can't answer 'will a UK 12 fit me?' and shoppers order one size up 'just in case'.",
  ...
  },
  {
    ...
    symptom:
      "Your 'Rainbow Pack T-Shirt' lists six colours as variants. Tidy for your ops team; absent at product level. A shopper asking 'black t-shirt' gets none of your six because the product itself has no colour — only its variants do, and they're buried.",
    pillar: 'Structured attributes',
    ...
    <main id="main" className="flintmere-main">
      <section className="bg-[color:var(--color-paper)] mx-auto max-w-[1280px] px-8 py-20 md:py-28">
        ...
        <h1 className="font-sans tracking-[-0.04em] leading-[0.88] text-[color:var(--color-ink)] mt-2">
          <Bracket size="saks">size</Bracket>
        </h1>
        <p
      ...
      >
        <div className="mx-auto max-w-[1280px] px-8 py-20 grid md:grid-cols-[auto_1fr_auto] gap-10 items-end">
          ...
          >
            {bench.available && !bench.preview
              ? 'The median apparel catalog scored by FlintmereBot. Updated periodically. Run your own scan to see where your store sits against it.'
              : bench.available
      ...
      >
        <div className="mx-auto max-w-[1280px] px-8 py-24">
          ...
          >
            ...
            drafted &mdash; title, structured size, structured colour,
            composition &mdash; a 30-day fix sequence, the right GS1 UK
            route for your supplier mix, and a 30-day re-scan. No video,
