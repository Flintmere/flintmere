...
const MISTAKES: Mistake[] = [
  ...
  },
  {
    ...
    symptom:
      "Your description talks about 'single-origin Ethiopian beans' or 'British free-range eggs'. Beautiful; no structured country_of_origin field. Agents serving 'British cheese' or 'Italian pasta' queries depend on this metafield. Your provenance-led positioning is prose, not product data.",
  ...
  {
    n: '08',
    title: 'Shipping restrictions undeclared in product data (alcohol, chilled, age-restricted)',
    symptom:
    ...
    <main id="main" className="flintmere-main">
      ...
      >
        <div className="mx-auto max-w-[1280px] px-8 py-20 grid md:grid-cols-[auto_1fr_auto] gap-10 items-end">
          ...
          >
            {bench.available && !bench.preview
              ? 'The median food & drink catalog scored by FlintmereBot. Updated periodically. Run your own scan to see where your store sits against it.'
              : bench.available
      ...
      >
        <div className="mx-auto max-w-[1280px] px-8 py-24">
          <p className="eyebrow" style={{ color: 'var(--color-accent)' }}>
            The Catalog Letter for food &amp; drink
          </p>
          <h2
            id="food-cta-heading"
