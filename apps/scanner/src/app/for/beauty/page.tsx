        ...
        {bench.available && !bench.preview ? (
          <div className="grid md:grid-cols-[1fr_auto] items-end gap-8">
            <div>
              ...
              >
                The median beauty store on Shopify scores{' '}
              ...
              >
                Based on {bench.n.toLocaleString()} beauty stores scanned by
                Flintmere across the last rolling window. Updated monthly.
                Run your own scan to see where your catalog sits against the
                median.
              </p>
            </div>
