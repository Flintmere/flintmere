...
export default async function RootLayout({
  ...
  // CSP nonce generated by middleware.ts and threaded via the x-nonce
  // request header. Inline <Script> tags pass nonce={nonce} so the
  // browser accepts them under the per-request 'nonce-{value}' in CSP.
  // JSON-LD scripts (type="application/ld+json") are exempt from
  // script-src per CSP spec — non-script types aren't gated.
