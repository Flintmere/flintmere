...
Amazon and Google both verify identifiers against GS1's records now. When they look up a reseller's number, the registered owner is the original 1990s prefix holder, not your brand — so the identifier does not match your product, and the listing is rejected or suppressed. Amazon has removed listings and, in some cases, suspended accounts over exactly this mismatch. The £5 you saved buys you a catalog full of numbers you then have to strip out and replace with real ones.
...
A readiness score is built from seven weighted pillars, and four of them — Titles, Consistency, Crawlability, and the non-GTIN parts of Identifiers such as brand — are readable and fixable from your public storefront, no purchase required. Front-loading your titles with the product type and brand, making your attributes agree with each other across variants, declaring the brand cleanly: that is roughly four-fifths of the score, and it costs effort, not money. Our companion piece on [how a catalog readiness score is built](/blog/catalog-readiness-scoring-explained) walks through each pillar and what it checks.
