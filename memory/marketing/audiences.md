...
- **Desired outcome**: Agency tier (£499/mo grandfathered — in-flight only; new agency sign-ups land on the food agency ladder, magnitudes WTP-pending), 25 client seats, white-label reports, API access, cross-client dashboard, per-client benchmarking. Turn Flintmere into a productised service line.
...
- 2026-06-19: Mid-market headline hook "[ Six ] pillars" → "[ Seven ]" (PR #79 6→7 migration; canonical `apps/scanner/src/lib/methodology-data.ts`). NOTE: this file still carries stale Agency "£399/mo" (now £499, grandfathered) and "Enterprise"-tier naming (renamed **Plus** per ADR 0017) at §3–§4 + the mapping table — left as-is (out of this task's pillar scope); flagged for a follow-up pricing/naming pass.
